 ...
 */
define("HOST", "mydb7.surftown.dk"); 			// The host you want to connect to. 
define("USER", "Realfic_hd3"); 			// The database username. 
define("PASSWORD", "ninja99"); 	// The database password. 
define("DATABASE", "Realfic_secure_login");             // The database name.
