...
?> 
    <div class="topbar">
		...
		echo "<div style='margin-left: 400px; font-size: 28px; color:#3EE83E; position: absolute;'>TEST SERVER <a href='http://$liveURL/?p=$p' target='_blank' class='fontawesome-external-link'></a></div>";
		}
		?>
