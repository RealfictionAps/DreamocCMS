...
<form action="hd3-configurator/callweb.php" method="post" name="formdchp" id="formdchp">
	...
	<div class="block">
		...
		<input name="auto_time" id="auto_time2" size="30" type="radio" checked ="checked" value="off"  id="dhcp_set">Off
	...
	<div class="block" style="width:300px;margin-bottom:70px">
		<input  style="float:right;"value="Export" type="submit" onclick="return submit_form()" name="submit" id="Send">
	</div>
</form>
</div>	  
</body>
